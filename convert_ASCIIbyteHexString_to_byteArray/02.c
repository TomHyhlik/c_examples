...
int main()
{
    ...
    /* message in hex*/
    uint8_t *str = "7B002272656C61793031223A302C2272656C61793032223A312C2272656C61793033223A302C2272656C61793034223A307D";

    printf("%s\n", (char*)str);
    printf("///////////////////////////////////////////////\n");

    uint8_t* data = convert_ASCIIbyteHexString_to_byteArray(str, strlen(str));
    uint8_t data_len = strlen(str) /2;
